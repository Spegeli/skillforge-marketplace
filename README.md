...
### [Review / Audit](https://github.com/Spegeli/skillforge-marketplace/tree/main/plugins/review-audit) — 12 Skills

_A Collection of Skills for Audit / Review Websites_

**Install this collection**
- **CLI:** `/plugin install review-audit@skillforge-spegeli`
- **Desktop App:** Go to **Settings → Extensions**, search for `skillforge-spegeli` and install **review-audit**.
...
| [`web-design-guidelines`](https://github.com/Spegeli/skillforge-marketplace/tree/main/plugins/review-audit/skills/web-design-guidelines) | Review UI code for Web Interface Guidelines compliance. Use when asked to "review my UI", "check accessibility", "audit design", "review UX", or "check my site against best practices". |

</details>

---

### [Test 1](https://github.com/Spegeli/skillforge-marketplace/tree/main/plugins/test-1) — 1 Skill · 1 Agent

**Install this collection**
- **CLI:** `/plugin install test-1@skillforge-spegeli`
- **Desktop App:** Go to **Settings → Extensions**, search for `skillforge-spegeli` and install **test-1**.
...
| Agent | Description |
|---|---|
| [`a11y-architect`](https://github.com/Spegeli/skillforge-marketplace/blob/main/plugins/test-1/agents/a11y-architect.md) | Accessibility Architect specializing in WCAG 2.2 compliance for Web and Native platforms. Use PROACTIVELY when designing UI components, establishing design systems, or auditing code for inclusive user experiences. |
...
_Last published: 2026-06-12 · [SkillForge](http://localhost:3000)_
