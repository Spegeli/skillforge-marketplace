...
_Test Collection for Skills + Agents_
...
| Agent | Description |
|---|---|
| [`a11y-architect`](https://github.com/Spegeli/skillforge-marketplace/blob/main/plugins/test/agents/a11y-architect.md) | Accessibility Architect specializing in WCAG 2.2 compliance for Web and Native platforms. Use PROACTIVELY when designing UI components, establishing design systems, or auditing code for inclusive user experiences. |
